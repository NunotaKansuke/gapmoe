...
#backend_path = "/home/nunota/work/gapmoe/test_result/backend/rerun_simu_02_kepler_chain_01.h5"
#reader = emcee.backends.HDFBackend(backend_path, read_only=True)
#chain = reader.get_chain()
#
#p0 = chain[-1]

kep_gap_chain_03,kep_gap_blob_03,kep_gap_prob_03 = read_chain("/moao38_7/nunota/gapmoe/test_result/rogue1/backend/rerun_simu_03_kepler_chain_01.h5",0,1,flat=False)
use_ind_gap_03 = np.where((kep_gap_chain_03[-1,:,0] < 10085.0025)&((np.abs(kep_gap_chain_03[-1,:,-2]) < 2.5)))[0]
samples = kep_gap_chain_03[100000:, use_ind_gap_03, :].reshape(-1, kep_gap_chain_03.shape[-1])
...
#backend = emcee.backends.HDFBackend("/home/nunota/work/gapmoe/test_result/backend/rerun_simu_03_kepler_chain_01.h5")
backend = emcee.backends.HDFBackend("/home/nunota/work/gapmoe/test_result/backend/rerun_simu_03_kepler_chain_02.h5")
